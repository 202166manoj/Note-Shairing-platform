                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Electronics</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
...
$ret = "SELECT COUNT(*) FROM notes WHERE Subject='ELTN' AND Level='level3'";
...
$sql="SELECT notes.*,users.* from notes join users on notes.UserID=users.id WHERE notes.Subject='ELTN' AND notes.Level='level3' LIMIT $offset, $no_of_records_per_page";
