...
$ret = "SELECT COUNT(*) FROM notes WHERE Subject='CMIS' AND Level='level4'";
...
$sql="SELECT notes.*,users.* from notes join users on notes.UserID=users.id WHERE notes.Subject='CMIS' AND notes.Level='level4' LIMIT $offset, $no_of_records_per_page";
