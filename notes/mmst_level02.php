                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Mathematical Sciences</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
...
$ret = "SELECT COUNT(*) FROM notes WHERE Subject='MMST' AND Level='level2'";
...
$sql="SELECT notes.*,users.* from notes join users on notes.UserID=users.id WHERE notes.Subject='MMST' AND notes.Level='level2' LIMIT $offset, $no_of_records_per_page";
