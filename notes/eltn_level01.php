...
$ret = "SELECT COUNT(*) FROM notes WHERE Subject='ELTN' AND Level='level1'";
...
$sql="SELECT notes.*,users.* from notes join users on notes.UserID=users.id WHERE notes.Subject='ELTN' AND notes.Level='level1' LIMIT $offset, $no_of_records_per_page";
