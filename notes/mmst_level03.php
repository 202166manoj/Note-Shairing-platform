...
$ret = "SELECT COUNT(*) FROM notes WHERE Subject='MMST' AND Level='level3'";
...
$sql="SELECT notes.*,users.* from notes join users on notes.UserID=users.id WHERE notes.Subject='MMST' AND notes.Level='level3' LIMIT $offset, $no_of_records_per_page";
