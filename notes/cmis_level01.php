                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Computing & Information Systems</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
...
$ret = "SELECT COUNT(*) FROM notes WHERE Subject='CMIS' AND Level='level1'";
...
$sql="SELECT notes.*,users.* from notes join users on notes.UserID=users.id WHERE notes.Subject='CMIS' AND notes.Level='level1' LIMIT $offset, $no_of_records_per_page";
